...
export class HighlightDirective implements OnChanges{
  ...
  constructor(private elementref : ElementRef , private rd: Renderer2) {
   ...
   @HostListener('mouseenter') onMouseEnter() {
    this.rd.setStyle(this.elementref.nativeElement,'background-color', 'orange');
   }
...
@Input() appHighlight="";
 @HostListener('mouseout') onMouseout() {
      this.rd.setStyle(this.elementref.nativeElement,'background-color', this.appHighlight||'yellow');
    }
